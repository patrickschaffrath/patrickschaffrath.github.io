...
Here is an example for vertices $$a, b, c, d$$ with the distance relationships $$dist(a,d) < dist(a,b) < dist(a,c)$$, $$dist(b,a) < dist(b,d) < dist(b,c)$$, $$dist(c,a) < dist(c,d) < dist(c,b)$$ and $$dist(d,a) < dist(d,b) < dist(d,c)$$. The $$4\choose 3$$ permutations are $$\{a,b,c\}$$, $$\{a,b,d\}$$, $$\{a,c,d\}$$ and $$\{b,c,d\}$$. The solutions are $$\{(a,b,c),(b,a,c),(c,a,b)\}$$, $$\{(a,d,b),(b,a,d),(d,a,b)\}$$, $$\{(a,d,c),(c,a,d),(d,a,c)\}$$ and $$\{(b,d,c),(c,d,b),(d,b,c)\}$$.
